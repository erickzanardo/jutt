...
public class DoTTest extends TemplateTest {
    ...
    public void testResult() {
        ...
        String template = Utils
                .readFile("src/main/webapp/template/dot/dummy-template-4.html");
    ...
    public void testString() {
        ...
        String template = Utils
                .readFile("src/main/webapp/template/dot/dummy-template.html");
        ...
        template = Utils
                .readFile("src/main/webapp/template/dot/dummy-template-2.html");
        doTemplate = doTemplateAsString(template, data);
        ...
        template = Utils
                .readFile("src/main/webapp/template/dot/dummy-template-3.html");
        doTemplate = doTemplateAsString(template, data);
        assertEquals("<h1 class='aaa'>Hello World</h1>", doTemplate);
